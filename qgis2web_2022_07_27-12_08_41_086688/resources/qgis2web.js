...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'ESRI:102003',
            extent: [-2292032.855500, -1638993.982300, 3157513.947900, 1158712.931100],
            units: 'm'})
    })
});


map.getView().fit([-2324108.094897, 301784.034267, -2235481.340350, 351548.969377], map.getSize());
